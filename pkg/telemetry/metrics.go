...
func (m *Metrics) WritePrometheus(w io.Writer) error {
	...
	values := []struct {
		...
		{"dxplane_connections_force_closed_total", "Total connections closed because the drain budget expired.", "counter", snapshot.ConnectionsForceClosed},
		...
		{"dxplane_terminating", "Set to 1 once the pod has started draining.", "gauge", boolValue(snapshot.Terminating)},
		{"dxplane_drain_duration_seconds", "Time the last completed drain took, in seconds.", "gauge", snapshot.DrainDuration.Seconds()},
	}
